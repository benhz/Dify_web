const translation = {
  ...
  stepTwo: {
    ...
    notAvailableForSemantic: 'Not available for Semantic Segmentation Index',
    ...
    thresholdAmountTip: 'Semantic breakpoint sensitivity (using percentile mode). Higher values are more conservative with fewer breakpoints and larger chunks. Range 80-99 (percentile %)',
    bufferSize: 'Buffer Size',
    bufferSizeTip: 'Number of context sentences to reference when determining breakpoints (smoothing window size). Higher values provide more stable segmentation but slower response. Range 0-5 (recommend 1-2), unit: sentences',
    minChunkTokens: 'Min Chunk Tokens',
