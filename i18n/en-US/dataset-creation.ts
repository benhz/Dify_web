const translation = {
  ...
  stepTwo: {
    ...
    thresholdAmountTip: 'Semantic similarity threshold for determining segmentation boundaries. Range 0-1, lower values require higher similarity.',
    bufferSize: 'Buffer Size',
    bufferSizeTip: 'Buffer size for smoothing semantic similarity calculations, in number of sentences.',
    targetChunkTokens: 'Target Chunk Tokens',
