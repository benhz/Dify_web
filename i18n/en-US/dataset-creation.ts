const translation = {
  ...
  stepTwo: {
    ...
    bufferSentences: 'Buffer Sentences',
    bufferSentencesTip: 'Number of context sentences to reference when determining breakpoints (smoothing window size). Higher values provide more stable segmentation but slower response. Range 0-5 (recommend 1-2)',
