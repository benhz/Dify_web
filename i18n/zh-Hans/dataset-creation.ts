const translation = {
  ...
  stepTwo: {
    ...
    thresholdAmount: '阈值数量',
    thresholdAmountTip: '语义相似度阈值，用于判断是否需要分段。取值范围 0-1，值越小表示相似度要求越高。',
    bufferSize: '缓冲区大小',
    bufferSizeTip: '用于平滑语义相似度计算的缓冲区大小，单位为句子数量。',
    targetChunkTokens: '目标块标记数',
    chunkOverlapTokens: '块重叠标记数',
    minChunkTokens: '最小块标记数',
    maxChunkTokens: '最大块标记数',
