const translation = {
  ...
  stepTwo: {
    ...
    notAvailableForSemantic: '不支持语义分段索引',
    ...
    thresholdAmount: '阈值数值',
    thresholdAmountTip: '语义断点敏感度（使用分位数模式）。数值越大越保守，断点更少，块更大。范围 80-99（分位%）',
    bufferSize: '缓冲区大小',
    bufferSizeTip: '判定断点时参考的上下文句子数量（平滑窗口大小）。数值越大切分更稳，但响应更慢。范围 0-5（推荐 1-2），单位：句',
    minChunkTokens: '最小块长度',
    maxChunkTokens: '最大块长度',
